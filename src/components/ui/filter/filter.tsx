...
export const Filter = () => {
  ...
  return (
    <aside
      className={classNames('filter', { filter__open: isOpen })}
      onClick={closeFilter}
    >
      <div
        className={classNames('filter__count', { filter__count__open: isOpen })}
      ...
      >
        <div className="filter__title_count">
          ...
          <div className="filter__img_count" onClick={closeFilter}>
            <SvgFinder
              src="close.svg"
              className="filter__img_close"
              alt="close"
            />
          </div>
        </div>
        <div className="filter__item_count">
          {filterItemPropsData.map((i) => (
            <FilterItem key={i.id} {...i} clearFilter={clearFilter} />
          ))}
        </div>
        <div className="filter__buttons">
          <button className="filter__button_clear" onClick={resetAllFilter}>
            Clear All
          </button>
