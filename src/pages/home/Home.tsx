...
import { ProductsBox } from 'src/components/productsBox'
...
export const Home = () => {
  ...
  const [clothesOnPage, setClothesOnPage] = useState (8)
    ...
    <div className='main'>
      ...
      <section className='new-in'>
        ...
        <div className='products__count cards'>
          <ProductsBox itemsCount={clothesOnPage} />
        </div>
        <Button classes={{ button: 'new-products__button' }} onClick={() => {
          setClothesOnPage (clothesOnPage + 4)
        }}>
          Shop New Arrivals
        </Button>
      </section>
